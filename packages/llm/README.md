...
Schema-first LLM core for cssltdcode. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@cssltdcode/llm"
import { OpenAI } from "@cssltdcode/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@cssltdcode/llm/providers"
