...
class Database extends Context.Service<Database, DatabaseShape>()("@cssltdcode/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@cssltdcode/example/UserStore") {
