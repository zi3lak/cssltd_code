...
import type {
  ...
  CssltdAudioTranscriptionsErrors,
  CssltdAudioTranscriptionsResponses,
  CssltdAuthStatusErrors,
  CssltdAuthStatusResponses,
  CssltdClawChatCredentialsErrors,
  CssltdClawChatCredentialsResponses,
  CssltdClawStatusErrors,
  CssltdClawStatusResponses,
  CssltdCloudSessionGetErrors,
  CssltdCloudSessionGetResponses,
  CssltdCloudSessionImportErrors,
  CssltdCloudSessionImportResponses,
  CssltdCloudSessionsErrors,
  CssltdCloudSessionsResponses,
  CssltdcodeAgentManagerListErrors,
  CssltdcodeAgentManagerListResponses,
  CssltdcodeAgentManagerRejectErrors,
  CssltdcodeAgentManagerRejectResponses,
  CssltdcodeAgentManagerReplyErrors,
  CssltdcodeAgentManagerReplyResponses,
  CssltdcodeAgentRequirementsErrors,
  CssltdcodeAgentRequirementsResponses,
  CssltdcodeHeapSnapshotErrors,
  CssltdcodeHeapSnapshotResponses,
  CssltdcodeNotebookListErrors,
  CssltdcodeNotebookListResponses,
  CssltdcodeNotebookRejectErrors,
  CssltdcodeNotebookRejectResponses,
  CssltdcodeNotebookReplyErrors,
  CssltdcodeNotebookReplyResponses,
  CssltdcodeRemoveAgentErrors,
  CssltdcodeRemoveAgentResponses,
  CssltdcodeRemoveSkillErrors,
  CssltdcodeRemoveSkillResponses,
  CssltdcodeSessionImportMessageErrors,
  CssltdcodeSessionImportMessageResponses,
  CssltdcodeSessionImportPartErrors,
  CssltdcodeSessionImportPartResponses,
  CssltdcodeSessionImportProjectErrors,
  CssltdcodeSessionImportProjectResponses,
  CssltdcodeSessionImportSessionErrors,
  CssltdcodeSessionImportSessionResponses,
  CssltdcodeSessionModelUsageErrors,
  CssltdcodeSessionModelUsageResponses,
  CssltdEditErrors,
  CssltdEditResponses,
  CssltdFimErrors,
  CssltdFimResponses,
  CssltdModelsImagesErrors,
  CssltdModelsImagesResponses,
  CssltdModesErrors,
  CssltdModesResponses,
  CssltdNotificationsErrors,
  CssltdNotificationsResponses,
  CssltdOrganizationSetErrors,
  CssltdOrganizationSetResponses,
  CssltdProfileErrors,
  CssltdProfileResponses,
  LocationRef,
  LspStatusErrors,
  LspStatusResponses,
  McpAddErrors,
...
class HeyApiRegistry<T> {
  ...
  get(key?: string): T {
    ...
    if (!instance) {
      throw new Error(`No SDK client found. Create one with "new CssltdClient()" to fix this error.`)
    }
    return instance
  }
...
export class App extends HeyApiClient {
   ...
   * List agents
   *
   * Get a list of all available AI agents in the Cssltd system.
   */
   ...
   * List skills
   *
   * Get a list of all available skills in the Cssltd system.
   */
...
export class Console extends HeyApiClient {
   ...
   *
   * Persist a new active Console account/org selection for the current local Cssltd state.
   */
...
export class Session extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Cssltd sessions across projects, sorted by most recently updated. Archived sessions are excluded by default.
   */
...
export class Config extends HeyApiClient {
   ...
   *
   * Retrieve the current global Cssltd configuration settings and preferences.
   */
   ...
   *
   * Update global Cssltd configuration settings and preferences.
   */
...
export class Global extends HeyApiClient {
   ...
   * Get health
   *
   * Get health information about the Cssltd server.
   */
   ...
   * Get global events
   *
   * Subscribe to global events from the Cssltd system using server-sent events.
   */
   ...
   * Dispose instance
   *
   * Clean up and dispose all Cssltd instances, releasing all resources.
   */
   ...
   * Upgrade cssltd
   *
   * Upgrade cssltd to the specified version or latest if not specified.
   */
...
export class Config2 extends HeyApiClient {
   ...
   * Get configuration
   *
   * Retrieve the current Cssltd configuration settings and preferences.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   *
   * Update Cssltd configuration settings and preferences.
   */
  public update<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get project rules
   *
   * List project instruction files used by Cssltd and return their current contents.
   */
   ...
   * Update model state
   *
   * Patch TUI-compatible model selections shared with Cssltd Console.
   */
...
export class Worktree extends HeyApiClient {
   ...
   * List worktrees
   *
   * List all git worktrees for the current project and whether Cssltd manages them.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Instance extends HeyApiClient {
   ...
   * Dispose instance
   *
   * Clean up and dispose the current Cssltd instance, releasing all resources.
   */
...
export class Path extends HeyApiClient {
   ...
   * Get paths
   *
   * Retrieve the current working directory and related path information for the Cssltd instance.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Command extends HeyApiClient {
   ...
   * List commands
   *
   * Get a list of all available commands in the Cssltd system.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Project extends HeyApiClient {
   ...
   * List all projects
   *
   * Get a list of projects that have been opened with Cssltd.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get current project
   *
   * Retrieve the currently active project that Cssltd is working with.
   */
...
export class Pty extends HeyApiClient {
   ...
   * List PTY sessions
   *
   * Get a list of all active pseudo-terminal (PTY) sessions managed by Cssltd.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
...
export class Session2 extends HeyApiClient {
   ...
   * List sessions
   *
   * Get a list of all Cssltd sessions, sorted by most recently updated.
   */
  public list<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Create session
   *
   * Create a new Cssltd session for interacting with AI assistants and managing conversations.
   */
  public create<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
   ...
   * Get session
   *
   * Retrieve detailed information about a specific Cssltd session.
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      sessionID: string
...
export class Indexing extends HeyApiClient {
  ...
  /**
   * List Cssltd embedding models
   *
   * Retrieve the embedding models available through the active Cssltd account.
   */
...
export class Audio extends HeyApiClient {
   ...
   *
   * Proxy an audio transcription request to the Cssltd Gateway
   */
...
export class Models extends HeyApiClient {
   ...
   *
   * List image-capable models from the Cssltd Gateway OpenRouter passthrough
   */
  public images<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<CssltdModelsImagesResponses, CssltdModelsImagesErrors, ThrowOnError>({
...
export class Organization extends HeyApiClient {
  /**
   * Update Cssltd Gateway organization
   *
   * Switch to a different Cssltd Gateway organization
   */
  public set<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).post<CssltdOrganizationSetResponses, CssltdOrganizationSetErrors, ThrowOnError>(
      {
...
export class Claw extends HeyApiClient {
  /**
   * Get CssltdClaw instance status
   *
   * Fetch the user's CssltdClaw instance status via the CssltdClaw worker
   */
  public status<ThrowOnError extends boolean = false>(
    parameters?: {
      directory?: string
    ...
    return (options?.client ?? this.client).get<CssltdClawStatusResponses, CssltdClawStatusErrors, ThrowOnError>({
  ...
  /**
   * Get CssltdClaw chat credentials
   *
   * Returns the bearer token and endpoint URLs the client uses to talk to the Cssltd Chat worker and the Event Service. The bearer is the user's existing long-lived Cssltd JWT — cssltd-chat and event-service both verify it directly with NEXTAUTH_SECRET, so no separate token mint is needed.
   */
...
export class Session3 extends HeyApiClient {
   ...
   * Get cloud session
   *
   * Fetch full session data from the Cssltd cloud for preview
   */
  public get<ThrowOnError extends boolean = false>(
    parameters: {
      id: string
    ...
    return (options?.client ?? this.client).get<CssltdCloudSessionGetResponses, CssltdCloudSessionGetErrors, ThrowOnError>({
...
export class Cssltd extends HeyApiClient {
  /**
   * Get Cssltd Gateway profile
   *
   * Fetch user profile and organizations from Cssltd Gateway
   */
  public profile<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<CssltdProfileResponses, CssltdProfileErrors, ThrowOnError>({
      url: "/cssltd/profile",
      ...options,
      ...params,
    })
  ...
  /**
   * Get Cssltd authentication status
   *
   * Check whether a locally stored Cssltd credential can authenticate Gateway requests
   */
  public authStatus<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<CssltdAuthStatusResponses, CssltdAuthStatusErrors, ThrowOnError>({
  ...
  public modes<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<CssltdModesResponses, CssltdModesErrors, ThrowOnError>({
      url: "/cssltd/modes",
      ...options,
      ...params,
    })
   ...
   * FIM completion
   *
   * Proxy a Fill-in-the-Middle completion request to the Cssltd Gateway
   */
  public fim<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).sse.post<CssltdFimResponses, CssltdFimErrors, ThrowOnError>({
      url: "/cssltd/fim",
      ...options,
      ...params,
      headers: {
  ...
  public edit<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<CssltdEditResponses, CssltdEditErrors, ThrowOnError>({
      url: "/cssltd/edit",
      ...options,
      ...params,
      headers: {
  ...
  /**
   * Get Cssltd notifications
   *
   * Fetch notifications from Cssltd Gateway for CLI display
   */
  public notifications<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<CssltdNotificationsResponses, CssltdNotificationsErrors, ThrowOnError>({
   ...
   * Get cloud sessions
   *
   * Fetch cloud CLI sessions from Cssltd API
   */
  public cloudSessions<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).get<CssltdCloudSessionsResponses, CssltdCloudSessionsErrors, ThrowOnError>({
...
export class Cssltdcode extends HeyApiClient {
  /**
  ...
  public removeSkill<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<CssltdcodeRemoveSkillResponses, CssltdcodeRemoveSkillErrors, ThrowOnError>(
      {
  ...
  public removeAgent<ThrowOnError extends boolean = false>(
    ...
    return (options?.client ?? this.client).post<CssltdcodeRemoveAgentResponses, CssltdcodeRemoveAgentErrors, ThrowOnError>(
      {
...
export class Telemetry extends HeyApiClient {
   ...
   *
   * Forward a telemetry event to PostHog via cssltd-telemetry.
   */
...
export class CssltdClient extends HeyApiClient {
  public static readonly __registry = new HeyApiRegistry<CssltdClient>()

  constructor(args?: { client?: Client; key?: string }) {
    super(args)
    CssltdClient.__registry.set(this, args?.key)
  }
  ...
  private _cssltd?: Cssltd
  get cssltd(): Cssltd {
    return (this._cssltd ??= new Cssltd({ client: this.client }))
  }

  private _cssltdcode?: Cssltdcode
  get cssltdcode(): Cssltdcode {
    return (this._cssltdcode ??= new Cssltdcode({ client: this.client }))
  }
