...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CSSLTD_CALLER", () => {
    process.env["CSSLTD_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CSSLTD_CALLER", () => {
    process.env["CSSLTD_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CSSLTD_CALLER", () => {
    process.env["CSSLTD_CALLER"] = "unknown"
