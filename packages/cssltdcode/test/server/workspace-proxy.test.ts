...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips cssltdcode-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-cssltd-directory"]).toBeUndefined()
      expect(forwarded["x-cssltd-workspace"]).toBeUndefined()
