...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips cssltdcode-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-cssltd-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-cssltd-directory")).toBeNull()
      expect(result.get("x-cssltd-workspace")).toBeNull()
