...
describe("tool parameters", () => {
  ...
  describe("shell", () => {
    ...
    // cssltdcode_change start - description is optional in cssltd (see bash.ts Parameters)
    test("accepts missing description (optional in cssltd)", () => {
  ...
  describe("websearch", () => {
    test("accepts query", () => {
      expect(parse(WebSearch, { query: "cssltdcode" }).query).toBe("cssltdcode")
    })
  })
