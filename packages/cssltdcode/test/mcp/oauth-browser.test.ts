...
void mock.module("open", () => ({
  default: async (url: string) => {
    ...
    if (openShouldFail) {
      // cssltdcode_change start - buffer the error until the consumer attaches
...
const { FSUtil } = await import("@cssltdcode/core/fs-util")
const { CrossSpawnSpawner } = await import("@cssltdcode/core/cross-spawn-spawner")
