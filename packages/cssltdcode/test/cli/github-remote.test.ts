...
// cssltdcode_change start: rebrand fixtures off upstream repo path
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/Cssltd-Org/cssltdcode.git")).toEqual({
    owner: "Cssltd-Org",
    repo: "cssltdcode",
  })
})
...
test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/Cssltd-Org/cssltdcode")).toEqual({ owner: "Cssltd-Org", repo: "cssltdcode" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:Cssltd-Org/cssltdcode.git")).toEqual({ owner: "Cssltd-Org", repo: "cssltdcode" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:Cssltd-Org/cssltdcode")).toEqual({ owner: "Cssltd-Org", repo: "cssltdcode" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/Cssltd-Org/cssltdcode.git")).toEqual({
    owner: "Cssltd-Org",
    repo: "cssltdcode",
  })
})
...
test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/Cssltd-Org/cssltdcode")).toEqual({ owner: "Cssltd-Org", repo: "cssltdcode" })
})
