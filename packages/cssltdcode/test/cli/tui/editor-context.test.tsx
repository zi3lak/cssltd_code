...
import { EditorContextProvider, useEditorContext, type EditorIntegration } from "@cssltdcode/tui/context/editor"
import { tmpdir } from "../../fixture/fixture"
import { FakeWebSocket } from "../../lib/websocket"
import { TestTuiContexts } from "../../fixture/tui-environment"
import { discoverEditorConnection } from "@cssltdcode/tui/editor"

const originalClaudePort = process.env.CLAUDE_CODE_SSE_PORT
const originalCssltdcodePort = process.env.CSSLTD_EDITOR_SSE_PORT

afterEach(() => {
  process.env.CLAUDE_CODE_SSE_PORT = originalClaudePort
  process.env.CSSLTD_EDITOR_SSE_PORT = originalCssltdcodePort
})
...
test("useEditorContext reconnect switches editor server by session directory", async () => {
  ...
  process.env.CSSLTD_EDITOR_SSE_PORT = undefined
...
test("useEditorContext connects with CSSLTD_EDITOR_SSE_PORT", async () => {
  await using tmp = await tmpdir()
  process.env.CLAUDE_CODE_SSE_PORT = undefined
  process.env.CSSLTD_EDITOR_SSE_PORT = "4020"
