...
export const SessionPaths = {
  ...
  viewed: `${root}/viewed`, // cssltdcode_change
} as const
      ...
      .add(
        HttpApiEndpoint.get("list", SessionPaths.list, {
          ...
          OpenApi.annotations({
            ...
            description: "Get a list of all Cssltd sessions, sorted by most recently updated.", // cssltdcode_change
          }),
        ),
        ...
        HttpApiEndpoint.get("get", SessionPaths.get, {
          ...
          OpenApi.annotations({
            ...
            summary: "Get session",
            description: "Retrieve detailed information about a specific Cssltd session.", // cssltdcode_change
          }),
        ),
        ...
        HttpApiEndpoint.post("create", SessionPaths.create, {
          ...
          OpenApi.annotations({
            ...
            description: "Create a new Cssltd session for interacting with AI assistants and managing conversations.", // cssltdcode_change
          }),
        ),
        ...
        HttpApiEndpoint.post("fork", SessionPaths.fork, {
          params: { sessionID: SessionID },
          query: WorkspaceRoutingQuery,
          payload: [HttpApiSchema.NoContent, ForkPayload], // cssltdcode_change - carry upstream bodyless full-session fork support
          success: described(Session.Info, "200"),
          error: [HttpApiError.BadRequest, ApiNotFoundError], // cssltdcode_change - carry upstream malformed payload response
        }).annotateMerge(
          OpenApi.annotations({
