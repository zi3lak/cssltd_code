...
import { TsClient } from "../cssltdcode/ts-client" // cssltdcode_change
...
export class Service extends Context.Service<Service, Interface>()("@cssltdcode/LSP") {}
    ...
    const getClients = Effect.fnUntraced(function* (file: string) {
      ...
      const clients = yield* Effect.promise(async () => {
        ...
        for (const server of Object.values(s.servers)) {
          ...
          // cssltdcode_change start - use lightweight tsgo-based client when persistent LSP is not enabled
