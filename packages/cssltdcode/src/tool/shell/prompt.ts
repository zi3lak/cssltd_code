...
// cssltdcode_change start - description is optional, prefixed with "Recommended:" so the model knows it can omit it
const descriptions = {
...
export function parameterSchema(description: string) {
  return Schema.Struct({
    ...
    description: Schema.optional(Schema.String).annotate({ description }), // cssltdcode_change - description is optional
  })
}
