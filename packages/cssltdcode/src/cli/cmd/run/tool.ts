// Per-tool display rules shared across `cssltd run` output paths. // cssltdcode_change
//
...
import type { ToolPart } from "@cssltdcode/sdk/v2"
...
import type { InteractiveTerminalTool } from "@/cssltdcode/tool/interactive-terminal" // cssltdcode_change
...
type ToolDefs = {
  ...
  interactive_terminal: typeof InteractiveTerminalTool // cssltdcode_change
