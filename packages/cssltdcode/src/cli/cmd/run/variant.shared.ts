...
//
// The saved variant persists across sessions in ~/.local/state/cssltd/model.json // cssltdcode_change
...
class Service extends Context.Service<Service, VariantService>()("@cssltdcode/RunVariant") {}
