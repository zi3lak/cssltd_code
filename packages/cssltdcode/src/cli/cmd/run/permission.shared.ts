...
export function permissionAlwaysLines(request: PermissionRequest): string[] {
  if (request.always.length === 1 && request.always[0] === "*") {
    return [`This will allow ${request.permission} until Cssltd is restarted.`] // cssltdcode_change
  }

  return [
    "This will allow the following patterns until Cssltd is restarted.", // cssltdcode_change
