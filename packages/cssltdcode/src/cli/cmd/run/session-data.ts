...
import type { Part, PermissionRequest, QuestionRequest, ToolPart } from "@cssltdcode/sdk/v2"
...
export type SessionData = {
  ...
  terminal?: RunInteractiveTerminalSnapshot // cssltdcode_change
...
export function reduceSessionData(input: SessionDataInput): SessionDataOutput {
  ...
  // cssltdcode_change start - direct interactive mode terminal footer
