...
// cssltdcode_change start - expose Effect stats aggregation for Cssltd regression coverage
      ...
      Effect.gen(function* () {
        ...
        for (const message of messages) {
          if (message.info.role === "assistant") {
            // cssltdcode_change start - count propagated subagent cost once but keep child model stats (#6321)
            ...
            sessionModelUsage[modelKey].cost += cost // cssltdcode_change
