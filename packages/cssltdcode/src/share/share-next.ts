...
const disabled = process.env["CSSLTD_DISABLE_SHARE"] === "true" || process.env["CSSLTD_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@cssltdcode/ShareNext") {}
...
// cssltdcode_change start - preserve the share transport contract when stored legacy summary diffs omit file details
