 ...
 *   "@cssltdcode/ServerAuthConfig",
 *   {
 *     password: Config.string("CSSLTD_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CSSLTD_SERVER_USERNAME").pipe(Config.withDefault("cssltdcode")),
 *   },
 * ) {}
 *
