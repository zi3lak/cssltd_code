...
export class Service extends Context.Service<Service, Interface>()("@cssltdcode/SessionRevert") {}
...
export const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const revert = Effect.fn("SessionRevert.revert")(function* (input: RevertInput) {
      ...
      // cssltdcode_change start - compute diffs BEFORE reverting files so the diff
      ...
      yield* sessions.setRevert({
        ...
        summary: {
          ...
          files: diffs.length,
          diffs: summaryDiffs, // cssltdcode_change
        },
      })
    ...
    const cleanup = Effect.fn("SessionRevert.cleanup")(function* (session: Session.Info) {
      ...
      if (session.revert.partID && target) {
        ...
        if (idx >= 0) {
          ...
          // cssltdcode_change start - clear a reverted provider error from the retained assistant message
