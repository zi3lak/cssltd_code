import type { JsonSchema, LLMRequest, ProviderMetadata } from "@cssltdcode/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@cssltdcode/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @cssltdcode/llm request objects from cssltdcode's session/AI SDK-shaped data.
  return LLM.request({
