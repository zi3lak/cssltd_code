import {
  ...
  Part as PartType,
} from "@cssltdcode/sdk/v2/client"
import type { SessionStatus } from "@cssltdcode/sdk/v2"
import { useData } from "../context"
import { useFileComponent } from "../context/file"

import { Binary } from "@cssltdcode/core/util/binary"
import { getDirectory, getFilename } from "@cssltdcode/core/util/path"
...
export function SessionTurn(
  ...
  const pending = createMemo(() => {
    if (typeof props.active === "boolean" && typeof props.queued === "boolean") return // cssltdcode_change
    const messages = allMessages() ?? emptyMessages
  ...
  // cssltdcode_change start — restore queued feature
  ...
  const showThinking = createMemo(() => {
    ...
    if (queued()) return false // cssltdcode_change
