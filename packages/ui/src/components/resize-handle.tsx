...
export function ResizeHandle(props: ResizeHandleProps) {
  ...
  const handleMouseDown = (e: MouseEvent) => {
    ...
    // cssltdcode_change start - set resize cursor on body during drag
    const cursor = local.direction === "horizontal" ? "col-resize" : "row-resize"
    // cssltdcode_change end
    document.body.style.userSelect = "none"
    document.body.style.overflow = "hidden"
    document.body.style.cursor = cursor // cssltdcode_change
    ...
    const onMouseUp = () => {
      ...
      document.body.style.cursor = "" // cssltdcode_change
