...
export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "En iyi açık kaynak modellere güvenilir erişim için Cssltd Go'ya abone olun. Aylık $5'tan başlar.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · {{total}} satırdan {{kept}} tanesi korundu", // cssltdcode_change
