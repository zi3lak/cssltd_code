export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Abonnér på Cssltd Go for pålidelig adgang til de bedste open source-modeller, fra $5/måned.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · {{kept}} af {{total}} linjer beholdt", // cssltdcode_change
  "ui.tool.list": "Liste",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
