export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "สมัครสมาชิก Cssltd Go เพื่อการเข้าถึงโมเดลโอเพนซอร์สที่ดีที่สุดอย่างเชื่อถือได้ เริ่มต้นที่ $5/เดือน",
  ...
  "ui.tool.swePruned": "SWE-Pruner · เก็บไว้ {{kept}} จาก {{total}} บรรทัด", // cssltdcode_change
  "ui.tool.list": "รายการ",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
