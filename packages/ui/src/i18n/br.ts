export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Assine o Cssltd Go para ter acesso confiável aos melhores modelos open-source, a partir de $5/mês.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · {{kept}} de {{total}} linhas mantidas", // cssltdcode_change
  "ui.tool.list": "Listar",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
