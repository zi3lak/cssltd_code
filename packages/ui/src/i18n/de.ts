...
export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Abonniere Cssltd Go für zuverlässigen Zugriff auf die besten Open-Source-Modelle, ab $5/Monat.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · {{kept}} von {{total}} Zeilen behalten", // cssltdcode_change
