...
export const dict: Record<Keys, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Abonner på Cssltd Go for pålitelig tilgang til de beste åpen kildekode-modellene, fra $5/måned.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · {{kept}} av {{total}} linjer beholdt", // cssltdcode_change
  "ui.tool.list": "Liste",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
