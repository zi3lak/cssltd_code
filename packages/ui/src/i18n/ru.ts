export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Подпишитесь на Cssltd Go для надёжного доступа к лучшим моделям с открытым исходным кодом, от $5/месяц.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · сохранено {{kept}} из {{total}} строк", // cssltdcode_change
  "ui.tool.list": "Список",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
