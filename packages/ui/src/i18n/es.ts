export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Suscríbete a Cssltd Go para acceso fiable a los mejores modelos de código abierto, desde $5/mes.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · {{kept}} de {{total}} líneas conservadas", // cssltdcode_change
  "ui.tool.list": "Listar",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
