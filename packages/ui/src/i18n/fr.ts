export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Abonnez-vous à Cssltd Go pour un accès fiable aux meilleurs modèles open source, à partir de $5/mois.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · {{kept}} lignes conservées sur {{total}}", // cssltdcode_change
  "ui.tool.list": "Lister",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
