export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "اشترك في Cssltd Go للحصول على وصول موثوق إلى أفضل النماذج مفتوحة المصدر، ابتداءً من $5/شهر.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · تم الاحتفاظ بـ {{kept}} من {{total}} سطرًا", // cssltdcode_change
  "ui.tool.list": "قائمة",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
