export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Subskrybuj Cssltd Go, aby uzyskać niezawodny dostęp do najlepszych modeli open source, od $5/miesiąc.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · zachowano {{kept}} z {{total}} wierszy", // cssltdcode_change
  "ui.tool.list": "Lista",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
