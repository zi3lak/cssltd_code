export const dict: Record<string, string> = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Subscribe to Cssltd Go for reliable access to the best open-source models, starting at $5/month.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · kept {{kept}} of {{total}} lines", // cssltdcode_change
  "ui.tool.list": "List",
  "ui.tool.glob": "Glob",
  "ui.tool.grep": "Grep",
  "ui.tool.task": "Task",
