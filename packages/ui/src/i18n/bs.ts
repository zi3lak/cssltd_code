...
export const dict = {
  ...
  "dialog.usageExceeded.freeTier.description":
    "Pretplatite se na Cssltd Go za pouzdan pristup najboljim open-source modelima, počevši od $5/mjesec.",
  ...
  "ui.tool.swePruned": "SWE-Pruner · zadržano {{kept}} od {{total}} redova", // cssltdcode_change
