...
const STORAGE_KEYS = {
  THEME_ID: "cssltdcode-theme-id",
  COLOR_SCHEME: "cssltdcode-color-scheme",
  THEME_CSS_LIGHT: "cssltdcode-theme-css-light",
  THEME_CSS_DARK: "cssltdcode-theme-css-dark",
} as const
