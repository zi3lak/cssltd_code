...
import defaultSoundPath from "@cssltdcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import questionSoundPath from "@cssltdcode/ui/audio/bip-bop-03.mp3" with { type: "file" }
import permissionSoundPath from "@cssltdcode/ui/audio/staplebops-06.mp3" with { type: "file" }
import errorSoundPath from "@cssltdcode/ui/audio/nope-03.mp3" with { type: "file" }
import doneSoundPath from "@cssltdcode/ui/audio/bip-bop-01.mp3" with { type: "file" }
import subagentDoneSoundPath from "@cssltdcode/ui/audio/yup-01.mp3" with { type: "file" }
...
const DEFAULT_TITLE = "Cssltd" // cssltdcode_change
const DEFAULT_PACK_ID = "cssltd.default" // cssltdcode_change
const KV_SOUND_PACK = "attention_sound_pack"
const TITLE_LIMIT = 80
const MESSAGE_LIMIT = 240
const BUILTIN_PACK: RegisteredSoundPack = {
  id: DEFAULT_PACK_ID,
  name: "Cssltd Default", // cssltdcode_change
  builtin: true,
  sounds: {
