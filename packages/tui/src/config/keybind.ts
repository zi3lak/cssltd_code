...
export const Definitions = {
  ...
  "prompt.vim.toggle": keybind("none", "Toggle vim modal editing in the prompt input"), // cssltdcode_change
  ...
  news_toggle: keybind("none", "Toggle news on home screen"), // cssltdcode_change
...
export const CommandMap = {
  ...
  news_toggle: "news.toggle", // cssltdcode_change
