...
import type { QuestionAnswer, QuestionRequest } from "@cssltdcode/sdk/v2"
import { useSDK } from "../../context/sdk"
import { SplitBorder } from "../../ui/border"
import { useTuiConfig } from "../../config"
import { useBindings, useCssltdcodeModeStack } from "../../keymap"
...
export function QuestionPrompt(props: {
  ...
  useBindings(() => {
    ...
    return {
      mode: QUESTION_MODE,
      // cssltdcode_change start - avoid intrusive key capture for non-blocking review questions
