...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/Cssltd-Org/cssltdcode/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for Cssltd-Org/cssltdcode...\n")
...
console.log("Fetching npm all-time downloads for cssltdcode-ai...\n")
const npmDownloads = await fetchNpmDownloads("cssltdcode-ai")
