...
Generates UPCOMING_CHANGELOG.md by running the cssltd changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for cssltd run (default: low)
      --quiet            Suppress cssltd command output unless it fails
...
const cmd = ["cssltd", "run"] // cssltdcode_change - cssltdcode -> cssltd
