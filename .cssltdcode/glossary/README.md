...
Use this folder for locale-specific translation guidance that supplements `.cssltdcode/agent/translator.md`.
...
- PR #12345: https://github.com/anomalyco/cssltdcode/pull/12345

## Do Not Translate (Locale Additions)

- `CssltdCode` (preserve casing)
