...
- PR #13942: https://github.com/anomalyco/cssltdcode/pull/13942

## Do Not Translate (Locale Additions)

- `Cssltd` (preserve casing in prose; keep `cssltd` only when it is part of commands, package names, paths, or code)
- `Cssltd Zen`
- `Cssltd CLI`
- `CLI`, `TUI`, `MCP`, `OAuth`
...
- Avoid `cssltdcode` in prose when referring to the product name; use `CssltdCode`
