...
- PR #15835: https://github.com/anomalyco/cssltdcode/pull/15835

## Do Not Translate (Locale Additions)

- `CssltdCode` (preserve casing in prose, docs, and UI copy)
- Keep lowercase `cssltdcode` in commands, package names, paths, URLs, and other exact identifiers
...
- Keep product naming consistent: `CssltdCode` in prose, `cssltdcode` only for exact technical identifiers
...
- Avoid changing `cssltdcode` to `CssltdCode` inside commands, URLs, package names, or code literals
